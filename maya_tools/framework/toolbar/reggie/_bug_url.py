"""Vendored copy of fabricator-mcp's bug_url module.

Deliberate copy, not an import (the _wire.py pattern): fabricator-mcp is a
separate, unshipped package inside Maya, so the Reggie panel carries its own
copy of the GitHub issue-URL builder. test_reggie_core.py holds this file
